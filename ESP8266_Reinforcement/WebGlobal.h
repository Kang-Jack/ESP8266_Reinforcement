...
void ReadConfig()
{
	...
	if (loadConfig())return ;
      ...
      config.MqttIP[0] = 192;config.MqttIP[1] = 168;config.MqttIP[2] = XXX;config.MqttIP[3] = XXX;
      config.MqttPort = XXXX;
      ...
      config.ota = false;
      config.mqtt_topic ="/ESP12";
      config.mqtt_subtopic = "/answer/data";
      config.mqtt_sub = "/home/ESP12/command";
      WriteConfig();
